...
public class JoinCLain implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String msg, String[] args) {
		if(sender instanceof Player) {
			...
			if(!p.hasPermission("Build.Admin")) {p.sendMessage("§ctu n'est pas admin");return false;}
			...
			if(!chunk.getCop().contains(p.getUniqueId())) {chunk.AddCoP(p.getUniqueId());}
		}else {
